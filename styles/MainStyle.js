...
export default StyleSheet.create({
    ...
    h3: {
        ...
        marginBottom: 5,
        fontSize: 20,
        color: Colours.roiGrey,  // COLOUR: medium grey
        lineHeight: 25,
    },
    listItem: {
        flex: 1,
    ...
    button: {
        ...
        backgroundColor: Colours.roiCharcoal,  // COLOUR: medium grey
        borderWidth: 1,
        borderColor: Colours.roiCharcoal,
        borderRadius: 20,
    },
    buttonText: {
        color: Colours.roiWhite,
        fontSize: 16,
        textAlign: 'center',
    },
    buttonMajor: {
    ...
    fieldSet: {
        ...
        borderWidth: 1,
        borderColor: Colours.roiCharcoal,  // COLOUR: light grey
        borderRadius: 5,
    },
    legend: {
        position: 'absolute',
        ...
        paddingHorizontal: 5,
        paddingVertical: 0,
        color: Colours.roiCharcoal,  // COLOUR: main secondary colour
        backgroundColor: 'white',
    },
    formRow: {
        flex: 1,
    ...
    navBar: {
        backgroundColor: Colours.roiLightGrey,  // COLOUR: dark grey
        borderTopColor: Colours.roiCharcoal,
        borderTopWidth: 1,
    },
    navBarIcon: {
        marginBottom: -5,
